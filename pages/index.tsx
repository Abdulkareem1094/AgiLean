...
import Cube from '../public/istockphoto.png'
import C1 from '../public/civicarm.png'
import C2 from '../public/ms.png'
import C3 from '../public/tf.png'
import C4 from '../public/sql.png'
import C5 from '../public/google.png'
import C6 from '../public/ms.png'
import C7 from '../public/aws.png'
import C8 from '../public/db.png'
import Rarrow from '../public/Vector.png'
import BP from '../public/Business Plan.png'
  ...
  return (
    <>
      ...
      <main className='w-full ' >
        <div className='bg-black h-screen px-16 text-white' > 
          <nav className='sticky top-0 left-0 flex justify-between px-16 h-fit w-full pt-8 ' >
            <div className='flex space-x-4' >
              <Image src={Logo} alt='' width={100} height={10} className='w-20 mr-9  my-auto h-fit object-cover' />
              <div className='group'>
                <button className='py-auto h-full px-4 group-hover:bg-button2 transition-all duration-300 '>Why Us &darr;</button>
                <div className='absolute space-y-3 -m-2 bg-[#B0C4CD] p-4 w-60 text-black text-xs rounded-xl hidden transition-all duration-300 group-hover:block'>
                  <p>How we help?</p>
                  <p>Why prefer us?</p>
                  <p>What we ensure?</p>
                </div>
          ...
          <div className='flex h-full' >
            <div className='flex my-auto h-fit' >
              <div className='w-2/3' >
                <p className='pt-6 text-[#FFFFFF8A] pb-2'>We are your product engine, from Strategic Insights to Tactical Execution</p>
                <h2 className='text-6xl ' >Being up-to-date is common; the competitive advantage is being up-to-tomorrow.</h2>
                <div className='relative w-96'>
                  <div className='flex border-white text-left border-[1px] rounded-xl w-full mt-10 h-12'>
                    <h2 className='my-auto ml-4 ' >Get Started</h2>
                    <button className='absolute top-0 right-0 h-full py-4 text-2xl px-8 rounded-xl bg-white text-black'  >
                      <Image src={Rarrow} alt='' width={100} height={100} className='h-full w-fit' />
                    </button>
                  </div>
                </div>
              </div>
              <Image src={Cube} width={10000} height={10000} alt='' className='w-1/3 object-cover ' />
            </div>
          </div>
        ...
        <div className='flex justify-center p-16 bg-[#B0C4CD] '  >
          <div className='flex flex-col gap-6 w-[700px] md my-auto'>
            <div className='flex justify-between w-full'>
              <Image src={C1} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
              <Image src={C2} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
              <Image src={C3} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
              <Image src={C4} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
            </div>
            <div className='flex justify-between'>
              <Image src={C5} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
              <Image src={C6} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
              <Image src={C7} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
              <Image src={C8} alt='' width={100} height={100} className='my-auto h-8 w-fit object-cover' />
            </div>
          </div>
        </div>
        ...
        <div className='relative px-16 bg-black text-[#bebebe] pt-4 ' >
          ...
          <div className='flex gap-10 mt-20 '>
            <Image src={BP} alt='' width={10000} height={10000} className='w-2/5 object-cover'/>
            <div className='w-3/5 my-auto text-2xl' >
          ...
          <div className='flex gap-10 mt-20 '>
            ...
            <Image src={Pair} alt='' width={10000} height={10000} className='w-2/5 object-cover'/>
          </div>
